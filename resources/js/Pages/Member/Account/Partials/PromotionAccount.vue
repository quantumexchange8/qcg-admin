...
const getResults = async () => {
    ...
    try {
        ...
        let url = `/member/getAccountListingPaginate?type=promotion&rows=${rows.value}&page=${page.value}`;
...
<template>
    ...
    >
        ...
        <template v-if="accounts?.length > 0">
            ...
            <Column field="created_at" :header="$t('public.created_on')" sortable class="w-full md:w-[15%] max-w-0" headerClass="hidden md:table-cell truncate">
                <template #body="slotProps">
                    ...
                    <div class="w-full md:w-1/2 flex items-center gap-1">
                        <div class="text-gray-500 text-xs md:hidden">{{ $t('public.created_on') }}</div>
            ...
            <Column field="meta_login" :header="$t('public.account')" sortable class="hidden md:table-cell w-[13%] max-w-0" headerClass="truncate">
                <template #body="slotProps">
            ...
            <Column field="balance" :header="`${$t('public.balance')}&nbsp;($)`" sortable class="hidden md:table-cell w-[13%] max-w-0" headerClass="truncate">
                <template #body="slotProps">
            ...
            <Column field="equity" :header="`${$t('public.equity')}&nbsp;($)`" sortable class="hidden md:table-cell w-[13%] max-w-0" headerClass="truncate">
                <template #body="slotProps">
                    <div class="text-gray-950 text-sm truncate">
            ...
            <Column field="credit" :header="`${$t('public.credit')}&nbsp;($)`" sortable class="hidden md:table-cell w-[13%] max-w-0" headerClass="truncate">
                <template #body="slotProps">
                    <div class="text-gray-950 text-sm truncate">
            ...
            <Column field="action" class="w-full md:w-[13%]" headerClass="hidden md:table-cell">
                <template #body="slotProps">
                    <Action 
    ...
    <Dialog v-model:visible="visible" modal :header="$t('public.account_details')" class="dialog-xs md:dialog-md" :dismissableMask="true">
        <div class="flex flex-col justify-center items-center gap-3 self-stretch pt-4 md:pt-6">
            <div class="flex justify-between items-center p-3 gap-3 self-stretch bg-gray-50">
            ...
            <div class="flex flex-col items-center p-3 gap-3 self-stretch bg-gray-50">
                <div class="w-full flex flex-col items-start gap-1 md:flex-row">
                    <span class="w-full max-w-[140px] truncate text-gray-500 text-sm">{{ $t('public.created_on') }}</span>
