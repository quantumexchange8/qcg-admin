...
const form = useForm({
    ...
    promotion_period_type: props.accountType.promotion_period_type || null,
    ...
    promotion_type: props.accountType.promotion_type || null,
    min_threshold: Number(props.accountType.min_threshold) || null,
    bonus_type: props.accountType.bonus_type || null,
    bonus_amount_type: props.accountType.bonus_amount_type || null,
    bonus_amount: Number(props.accountType.bonus_amount) || null,
    target_amount: Number(props.accountType.target_amount) || null,
    applicable_deposit: props.accountType.applicable_deposit || null,
    credit_withdraw_policy: props.accountType.credit_withdraw_policy || null,
