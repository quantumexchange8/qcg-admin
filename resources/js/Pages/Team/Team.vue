        ...
        <div class="w-full flex flex-col items-center gap-5">
            <div class="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-4 self-stretch md:gap-5">
                ...
                >
                    ...
                    <span class="self-stretch text-gray-950 text-lg font-semibold">{{ item.total }}</span>
                </div>
            </div>

            <div class="flex flex-col justify-center items-center px-3 py-5 gap-5 self-stretch rounded-lg bg-white shadow-card md:p-6 md:gap-6"></div>
